    ...
    <div class="quest-modal">
      <div class="quest-header">
        <div class="quest-title-section">
          ...
          <h2 class="quest-title">{{ issue?.title || 'JIRA Issue' }}</h2>
        </div>
      ...
      <div class="quest-content">
        ...
        <div class="quest-labels" v-if="issue?.labels && issue.labels.length > 0">
          <h3>🏷️ Labels</h3>
        ...
        <div class="quest-description">
          ...
          <div class="description-content">
            <div v-if="issue?.description" v-html="issue.description" class="formatted-description"></div>
            <p v-else class="no-description">No description available for this issue.</p>
          </div>
        </div>
      </div>
